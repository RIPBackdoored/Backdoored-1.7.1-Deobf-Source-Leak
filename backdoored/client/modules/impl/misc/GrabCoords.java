...
@g$i(name = "Grab Coords", description = "Copy coords to clipboard", category = y.MISC)
public class GrabCoords extends g
{
    ...
    public void v() {
        r.r(r.d(GrabCoords.mc.player.getPositionVector(), new boolean[0]));
        h.o("Copied coords to clipboard", "red");
        this.s(false);
        r();
    }
