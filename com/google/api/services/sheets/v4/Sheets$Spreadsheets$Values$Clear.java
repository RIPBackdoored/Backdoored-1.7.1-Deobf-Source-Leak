...
public class Clear extends SheetsRequest<ClearValuesResponse>
{
    ...
    protected Clear(final Values this$2, final String s, final String s2, final ClearValuesRequest clearValuesRequest) {
        this.this$2 = this$2;
        ...
        this.range = Preconditions.<String>checkNotNull(s2, (Object)"Required parameter range must be specified.");
    }
