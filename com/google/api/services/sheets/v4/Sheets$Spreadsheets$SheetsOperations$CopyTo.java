...
public class CopyTo extends SheetsRequest<SheetProperties>
{
    ...
    protected CopyTo(final SheetsOperations this$2, final String s, final Integer n, final CopySheetToAnotherSpreadsheetRequest copySheetToAnotherSpreadsheetRequest) {
        this.this$2 = this$2;
        ...
        this.sheetId = Preconditions.<Integer>checkNotNull(n, (Object)"Required parameter sheetId must be specified.");
    }
