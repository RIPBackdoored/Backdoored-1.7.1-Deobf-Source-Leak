...
class StorageImpl$15 implements Callable<StorageRpc.RewriteResponse> {
    ...
    StorageImpl$15(final StorageImpl this$0, final StorageObject val$source, final Map val$sourceOptions, final CopyRequest val$copyRequest, final StorageObject val$targetObject, final Map val$targetOptions) {
        this.this$0 = this$0;
