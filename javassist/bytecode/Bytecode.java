...
public class Bytecode extends ByteVector implements Cloneable, Opcode
{
    ...
    public void addInvokestatic(final CtClass ctClass, final String s, final String s2) {
        this.addInvokestatic(this.constPool.addClassInfo(ctClass), s, s2, ctClass != Bytecode.THIS && ctClass.isInterface());
    }
    ...
    @Override
    public /* bridge */ void add(final int n, final int n2, final int n3, final int n4) {
        super.add(n, n2, n3, n4);
    }
    
    @Override
    public /* bridge */ void add(final int n, final int n2) {
        super.add(n, n2);
    }
