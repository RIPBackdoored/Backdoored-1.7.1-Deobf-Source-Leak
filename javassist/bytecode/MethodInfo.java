...
public class MethodInfo
{
    ...
    void prune(final ConstPool constPool) {
        final ArrayList<AnnotationDefaultAttribute> attribute = new ArrayList<AnnotationDefaultAttribute>();
        final AttributeInfo attribute2 = this.getAttribute("RuntimeInvisibleAnnotations");
        if (attribute2 != null) {
            attribute.add((AnnotationDefaultAttribute)attribute2.copy(constPool, null));
        }
        final AttributeInfo attribute3 = this.getAttribute("RuntimeVisibleAnnotations");
        if (attribute3 != null) {
            attribute.add((AnnotationDefaultAttribute)attribute3.copy(constPool, null));
        }
        final AttributeInfo attribute4 = this.getAttribute("RuntimeInvisibleParameterAnnotations");
        if (attribute4 != null) {
            attribute.add((AnnotationDefaultAttribute)attribute4.copy(constPool, null));
        }
        final AttributeInfo attribute5 = this.getAttribute("RuntimeVisibleParameterAnnotations");
        if (attribute5 != null) {
            attribute.add((AnnotationDefaultAttribute)attribute5.copy(constPool, null));
        }
        ...
        if (exceptionsAttribute != null) {
            attribute.add((AnnotationDefaultAttribute)exceptionsAttribute);
        }
        final AttributeInfo attribute6 = this.getAttribute("Signature");
        if (attribute6 != null) {
            attribute.add((AnnotationDefaultAttribute)attribute6.copy(constPool, null));
        }
    ...
    private void read(final MethodInfo methodInfo, final String cachedName, final Map map) throws BadBytecode {
        final ConstPool constPool = this.constPool;
