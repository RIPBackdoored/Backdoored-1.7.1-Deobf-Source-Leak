...
public abstract class CodeGen extends Visitor implements Opcode, TokenId
{
    ...
    private void atWhileStmnt(final Stmnt stmnt, final boolean b) throws CompileError {
        ...
        final ArrayList continueList = this.continueList;
    ...
    protected void patchGoto(final ArrayList list, final int n) {
    ...
    private void atSwitchStmnt(final Stmnt stmnt) throws CompileError {
        ...
        for (ASTList tail2 = stmnt2; tail2 != null; tail2 = tail2.tail()) {
            ...
            if (operator == 310) {
                ...
                array[n3++] = ((long)this.computeLabel(stmnt3.head()) << 32) + ((long)(this.bytecode.currentPc() - currentPc) & -1L);
            }
            this.hasReturned = false;
        ...
        int n4 = currentPc2 + 8;
        for (int i = 0; i < n2; ++i) {
            this.bytecode.write32bit(n4, (int)(array[i] >>> 32));
            this.bytecode.write32bit(n4 + 4, (int)array[i]);
            n4 += 8;
        }
    ...
    private void atBreakStmnt(final Stmnt stmnt, final boolean b) throws CompileError {
        ...
        this.bytecode.addOpcode(167);
        final Integer n = new Integer(this.bytecode.currentPc());
        this.bytecode.addIndex(0);
        if (b) {
    ...
    private void atSyncStmnt(final Stmnt stmnt) throws CompileError {
        ...
        final ReturnHook returnHook = new ReturnHook(this) {
            final /* synthetic */ int val$var;
            final /* synthetic */ CodeGen this$0;
            
            CodeGen$1(final CodeGen codeGen) {
                this.this$0 = this$0;
                super(codeGen);
            }
    ...
    private boolean invalidDim(final int n, final int n2, final String s, final int n3, final int n4, final String s2, final boolean b) {
        return n2 != n4 && n != 412 && (n3 != 307 || !"java/lang/Object".equals(s2)) && (!b || n != 307 || !"java/lang/Object".equals(s));
    }
    ...
    public void atBinExpr(final BinExpr binExpr) throws CompileError {
        ...
        if (lookupBinOp >= 0) {
            ...
            if (operator == 43 && (exprType == 307 || this.exprType == 307)) {
    ...
    private boolean booleanExpr(final boolean b, final ASTree asTree) throws CompileError {
        ...
        if (compOperator == 358) {
            ...
            if (compOperator == 33) {
                return this.booleanExpr(true, ((Expr)asTree).oprand1());
            }
            final boolean b2;
            if ((b2 = (compOperator == 369)) || compOperator == 368) {
                final BinExpr binExpr2 = (BinExpr)asTree;
                if (this.booleanExpr(true, binExpr2.oprand1())) {
                    this.exprType = 301;
                    this.arrayDim = 0;
                    return true;
                }
