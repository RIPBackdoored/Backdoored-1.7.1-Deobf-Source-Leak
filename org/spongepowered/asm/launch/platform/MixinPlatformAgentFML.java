...
public class MixinPlatformAgentFML extends MixinPlatformAgentAbstract
{
    ...
    private boolean isAlreadyInjected(final String s) {
        ...
        try {
            final List<ITweaker> list = GlobalProperties.<List<ITweaker>>get("Tweaks");
            if (list == null) {
                return false;
            }
    ...
    private static boolean isTweakerQueued(final String s) {
        final Iterator<String> iterator = GlobalProperties.<List<String>>get("TweakClasses").iterator();
