...
public class MixinServiceLaunchWrapper implements IMixinService, IClassProvider, IClassBytecodeProvider
{
    ...
    public void init() {
        ...
        final List<String> list = GlobalProperties.<List<String>>get("TweakClasses");
        if (list != null) {
    ...
    public Collection<String> getPlatformAgents() {
        return ImmutableList.<String>of("org.spongepowered.asm.launch.platform.MixinPlatformAgentFML");
    }
    ...
    public URL[] getClassPath() {
        return Launch.classLoader.getSources().<URL>toArray(new URL[0]);
    }
    ...
    public final String getSideName() {
        for (final ITweaker tweaker : GlobalProperties.<List<ITweaker>>get("Tweaks")) {
