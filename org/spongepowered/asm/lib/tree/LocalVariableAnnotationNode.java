...
public class LocalVariableAnnotationNode extends TypeAnnotationNode
{
    ...
    public LocalVariableAnnotationNode(final int n, final int n2, final TypePath typePath, final LabelNode[] array, final LabelNode[] array2, final int[] array3, final String s) {
        ...
        (this.start = new ArrayList<LabelNode>(array.length)).addAll(Arrays.<LabelNode>asList(array));
        (this.end = new ArrayList<LabelNode>(array2.length)).addAll(Arrays.<LabelNode>asList(array2));
