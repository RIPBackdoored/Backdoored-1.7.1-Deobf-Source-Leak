...
public class BasicInterpreter extends Interpreter<BasicValue> implements Opcodes
{
    ...
    @Override
    public /* bridge */ void returnOperation(final AbstractInsnNode abstractInsnNode, final Value value, final Value value2) throws AnalyzerException {
        this.returnOperation(abstractInsnNode, (BasicValue)value, (BasicValue)value2);
    }
    
    @Override
    public /* bridge */ Value naryOperation(final AbstractInsnNode abstractInsnNode, final List list) throws AnalyzerException {
        return this.naryOperation(abstractInsnNode, list);
    }
    
    @Override
    public /* bridge */ Value ternaryOperation(final AbstractInsnNode abstractInsnNode, final Value value, final Value value2, final Value value3) throws AnalyzerException {
        return this.ternaryOperation(abstractInsnNode, (BasicValue)value, (BasicValue)value2, (BasicValue)value3);
    }
    
    @Override
    public /* bridge */ Value binaryOperation(final AbstractInsnNode abstractInsnNode, final Value value, final Value value2) throws AnalyzerException {
        return this.binaryOperation(abstractInsnNode, (BasicValue)value, (BasicValue)value2);
    }
    
    @Override
    public /* bridge */ Value unaryOperation(final AbstractInsnNode abstractInsnNode, final Value value) throws AnalyzerException {
        return this.unaryOperation(abstractInsnNode, (BasicValue)value);
    }
    
    @Override
    public /* bridge */ Value copyOperation(final AbstractInsnNode abstractInsnNode, final Value value) throws AnalyzerException {
        return this.copyOperation(abstractInsnNode, (BasicValue)value);
    }
    
    @Override
    public /* bridge */ Value newOperation(final AbstractInsnNode abstractInsnNode) throws AnalyzerException {
