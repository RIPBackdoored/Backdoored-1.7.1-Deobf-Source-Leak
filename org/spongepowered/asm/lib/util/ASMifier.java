...
public class ASMifier extends Printer
{
    ...
    @Override
    public /* bridge */ Printer visitTryCatchAnnotation(final int n, final TypePath typePath, final String s, final boolean b) {
        return this.visitTryCatchAnnotation(n, typePath, s, b);
    }
    
    @Override
    public /* bridge */ Printer visitInsnAnnotation(final int n, final TypePath typePath, final String s, final boolean b) {
        return this.visitInsnAnnotation(n, typePath, s, b);
    }
    
    @Override
    public /* bridge */ Printer visitParameterAnnotation(final int n, final String s, final boolean b) {
        return this.visitParameterAnnotation(n, s, b);
    }
    
    @Override
    public /* bridge */ Printer visitMethodTypeAnnotation(final int n, final TypePath typePath, final String s, final boolean b) {
        return this.visitMethodTypeAnnotation(n, typePath, s, b);
    }
    
    @Override
    public /* bridge */ Printer visitMethodAnnotation(final String s, final boolean b) {
    ...
    @Override
    public /* bridge */ Printer visitFieldTypeAnnotation(final int n, final TypePath typePath, final String s, final boolean b) {
        return this.visitFieldTypeAnnotation(n, typePath, s, b);
    }
    
    @Override
    public /* bridge */ Printer visitFieldAnnotation(final String s, final boolean b) {
        return this.visitFieldAnnotation(s, b);
    }
    
    @Override
    public /* bridge */ Printer visitArray(final String s) {
        return this.visitArray(s);
    }
    
    @Override
    public /* bridge */ Printer visitAnnotation(final String s, final String s2) {
        return this.visitAnnotation(s, s2);
    }
    
    @Override
    public /* bridge */ Printer visitMethod(final int n, final String s, final String s2, final String s3, final String[] array) {
        return this.visitMethod(n, s, s2, s3, array);
    }
    
    @Override
    public /* bridge */ Printer visitField(final int n, final String s, final String s2, final String s3, final Object o) {
        return this.visitField(n, s, s2, s3, o);
    }
    
    @Override
    public /* bridge */ Printer visitClassTypeAnnotation(final int n, final TypePath typePath, final String s, final boolean b) {
        return this.visitClassTypeAnnotation(n, typePath, s, b);
    }
    
    @Override
    public /* bridge */ Printer visitClassAnnotation(final String s, final boolean b) {
