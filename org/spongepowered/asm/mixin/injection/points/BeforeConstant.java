...
public class BeforeConstant extends InjectionPoint
{
    ...
    public BeforeConstant(final IMixinContext mixinContext, final AnnotationNode annotationNode, final String s) {
        super(Annotations.<String>getValue(annotationNode, "slice", ""), Selector.DEFAULT, null);
        final Boolean b = Annotations.<Boolean>getValue(annotationNode, "nullValue", (Boolean)null);
        this.ordinal = Annotations.<Integer>getValue(annotationNode, "ordinal", -1);
        this.nullValue = (b != null && b);
        this.intValue = Annotations.<Integer>getValue(annotationNode, "intValue", (Integer)null);
        this.floatValue = Annotations.<Float>getValue(annotationNode, "floatValue", (Float)null);
        this.longValue = Annotations.<Long>getValue(annotationNode, "longValue", (Long)null);
        this.doubleValue = Annotations.<Double>getValue(annotationNode, "doubleValue", (Double)null);
        this.stringValue = Annotations.<String>getValue(annotationNode, "stringValue", (String)null);
        this.typeValue = Annotations.<Type>getValue(annotationNode, "classValue", (Type)null);
        this.matchByType = this.validateDiscriminator(mixinContext, s, b, "on @Constant annotation");
        this.expandOpcodes = this.parseExpandOpcodes(Annotations.<Constant.Condition>getValue(annotationNode, "expandZeroConditions", true, Constant.Condition.class));
        this.expand = (this.expandOpcodes.length > 0);
        this.log = Annotations.<Boolean>getValue(annotationNode, "log", Boolean.FALSE);
    }
