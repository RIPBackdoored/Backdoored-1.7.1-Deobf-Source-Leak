...
public final class InterfaceInfo
{
    ...
    static InterfaceInfo fromAnnotation(final MixinInfo mixinInfo, final AnnotationNode annotationNode) {
        final String s = Annotations.<String>getValue(annotationNode, "prefix");
        final Type type = Annotations.<Type>getValue(annotationNode, "iface");
        final Boolean b = Annotations.<Boolean>getValue(annotationNode, "unique");
        if (s == null || type == null) {
