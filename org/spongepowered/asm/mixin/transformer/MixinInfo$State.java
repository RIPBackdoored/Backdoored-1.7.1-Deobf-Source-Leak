...
class State
{
    ...
    private void validateRemappable(final Class<Shadow> clazz, final String s, final AnnotationNode annotationNode) {
        if (annotationNode != null && Annotations.<Boolean>getValue(annotationNode, "remap", Boolean.TRUE)) {
    ...
    void readImplementations(final SubType subType) {
        ...
        final List<AnnotationNode> list = Annotations.<List<AnnotationNode>>getValue(invisible);
        if (list == null) {
            return;
        }
