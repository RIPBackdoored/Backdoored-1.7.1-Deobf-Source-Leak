...
public class MixinTargetContext extends ClassContext implements IMixinContext
{
    ...
    MixinTargetContext(final MixinInfo mixin, final ClassNode classNode, final TargetClassContext targetClass) {
        ...
        final InnerClassGenerator innerClassGenerator = targetClass.getExtensions().<InnerClassGenerator>getGenerator(InnerClassGenerator.class);
    ...
    private String transformSingleDescriptor(final String s, final boolean b) {
        String s2 = s;
    ...
    MethodNode findMethod(final MethodNode methodNode, final AnnotationNode annotationNode) {
        ...
        if (annotationNode != null) {
            final List<? extends String> list2 = Annotations.<List<? extends String>>getValue(annotationNode, "aliases");
            if (list2 != null) {
