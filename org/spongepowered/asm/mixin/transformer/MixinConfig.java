...
final class MixinConfig implements Comparable<MixinConfig>, IMixinConfig
{
    ...
    public List<String> getClasses() {
        return Collections.<String>unmodifiableList((List<? extends String>)this.mixinClasses);
    }
    ...
    public Set<String> getTargets() {
        return Collections.<String>unmodifiableSet((Set<? extends String>)this.mixinMapping.keySet());
    }
    
    public Set<String> getUnhandledTargets() {
        return Collections.<String>unmodifiableSet((Set<? extends String>)this.unhandledTargets);
    }
    ...
    static Config create(final String s, final MixinEnvironment mixinEnvironment) {
        try {
            ...
            final MixinConfig mixinConfig = new Gson().<MixinConfig>fromJson(new InputStreamReader(service.getResourceAsStream(s)), MixinConfig.class);
