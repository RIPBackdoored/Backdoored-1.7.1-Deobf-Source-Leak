...
public final class Bytecode
{
    ...
    public static void textify(final MethodNode methodNode, final OutputStream outputStream) {
        ...
        methodNode.accept(traceClassVisitor.visitMethod(methodNode.access, methodNode.name, methodNode.desc, methodNode.signature, methodNode.exceptions.<String>toArray(new String[0])));
