...
public class TypeHandle
{
    ...
    public <T extends Element> List<T> getEnclosedElements(final ElementKind... array) {
        return TypeHandle.<T>getEnclosedElements(this.getTargetElement(), array);
    }
    ...
    public String findDescriptor(final MemberInfo memberInfo) {
        ...
        if (s == null) {
            for (final ExecutableElement executableElement : this.<ExecutableElement>getEnclosedElements(ElementKind.METHOD)) {
    ...
    public FieldHandle findField(final String s, final String s2, final boolean b) {
        ...
        for (final VariableElement variableElement : this.<VariableElement>getEnclosedElements(ElementKind.FIELD)) {
    ...
    protected static MethodHandle findMethod(final TypeHandle typeHandle, final String s, final String s2, final String s3, final boolean b) {
        for (final ExecutableElement executableElement : TypeHandle.<ExecutableElement>getEnclosedElements(typeHandle.getTargetElement(), ElementKind.CONSTRUCTOR, ElementKind.METHOD)) {
    ...
    protected static List<? extends Element> getEnclosedElements(final TypeElement typeElement) {
        return (typeElement != null) ? typeElement.getEnclosedElements() : Collections.<? extends Element>emptyList();
    }
}
